...
$descript = 'Get the latest vehicle accessories at affordable prices. Get extra pay for buying from our e-shop.';
...
?>
   ...
   <div class="container">
        ...
        <div class="row">
              <?php
			//to show active
			$active_vehicle_items = 1;
			?>
			<?php include("../incs_shop/leftpanel.php");?>
            <?php include ('../incs_shop/paginate.php');?>
		   <?php 
		   
		   $statement = "goods WHERE categories = 'Vehicle Accessories' ORDER BY goods_timestamp DESC"; 
			...
			<div class="col-xs-6 col-sm-8 col-md-9">
                ...
                <div class="row">
                    <div class="btn-group alg-right-pad">
						...
						<?php 
						$total_products = mysqli_query($connect, "SELECT * FROM goods WHERE categories = 'Vehicle Accessories'") or die(db_conn_error);
                ...
                <!-- /.row -->
                <div class="row">
                      <?php echo pagination($statement,$per_page,$page,$url=MYSHOPTWO."/vehicle-accessories.php?"); ?>
                </div>
                <!-- /.row -->
