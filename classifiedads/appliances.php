...
$page_title = 'Electronics Appliances - Myshoptwo';
$descript = 'Get the latest gadgets and appliances at affordable prices. Get extra pay for buying from our e-shop.';
...
?>
   ...
   <div class="container">
        ...
        <div class="row">
		   ...
		   $statement = "goods WHERE categories = 'Appliances' ORDER BY goods_timestamp DESC"; 
			...
			<div class="col-xs-6 col-sm-8 col-md-9">
                ...
                <div class="row">
                    <div class="btn-group alg-right-pad">
						...
						<?php 
						$total_products = mysqli_query($connect, "SELECT * FROM goods WHERE categories = 'Appliances'") or die(db_conn_error);
                ...
                <!-- /.row -->
                <div class="row">
                      <?php echo pagination($statement,$per_page,$page,$url=MYSHOPTWO."/appliances.php?"); ?>
                </div>
                <!-- /.row -->
