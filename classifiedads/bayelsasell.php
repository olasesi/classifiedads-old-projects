...
require("../incs_shop/serv_con.inc.php");
			...
			$need_sell_post_ad_query = mysqli_query($connect,"SELECT * FROM sell, users WHERE user_id_sell = user_id AND post_state_id_sell = 'Bayelsa' ORDER BY php_timestamp_sell DESC LIMIT 0 , 5") or die(db_conn_error);	
