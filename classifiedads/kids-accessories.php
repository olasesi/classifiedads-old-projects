...
$descript = 'Get the latest kids accessories at affordable prices. Get extra pay for buying from our e-shop.';
...
?>
   ...
   <div class="container">
        ...
        <div class="row">
		   ...
		   $statement = "goods WHERE categories = 'Kids Accessories' ORDER BY goods_timestamp DESC"; 
			...
			<div class="col-xs-6 col-sm-8 col-md-9">
                ...
                <div class="row">
                    <div class="btn-group alg-right-pad">
						...
						<?php 
						$total_products = mysqli_query($connect, "SELECT * FROM goods WHERE categories = 'Kids Accessories'") or die(db_conn_error);
                ...
                <!-- /.row -->
                <div class="row">
                      <?php echo pagination($statement,$per_page,$page,$url=MYSHOPTWO."/kids-accessories.php?"); ?>
                </div>
                <!-- /.row -->
