...
echo("<div class='box_after_header_post'>");
	...
	$post = mysqli_query($connect,"SELECT * FROM post WHERE post_state_id = 'Lagos'  ORDER BY php_timestamp DESC LIMIT 0 , 5") or die(db_conn_error);
	...
	echo('<div class="clearfix" style="margin-bottom:20px;">');
		...
		echo '<div class="pull-right"><a href="tel:'.$post_question['phone'].'"><span class="label label-info">Call</span></a></div>';
