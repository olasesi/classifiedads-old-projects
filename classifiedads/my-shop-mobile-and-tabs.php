...
?>
  ...
  <div class="container">
        ...
        <div class="row">
		   ...
		   $statement = "goods WHERE categories = 'Mobile and Tabs' AND UID = '".$user_id."' ORDER BY goods_timestamp DESC"; 
			...
			<div class="col-xs-6 col-sm-8 col-md-9">
                ...
                <div class="row">
                    <div class="btn-group alg-right-pad">
						...
						<?php 
						$total_products = mysqli_query($connect, "SELECT * FROM goods WHERE categories = 'Mobile and Tabs' AND UID = '".$user_id."'") or die(db_conn_error);
                ...
                <!-- /.row -->
                <div class="row">
                      <?php echo pagination($statement,$per_page,$page,$url=MYSHOPTWO."/my-shop-mobile-and-tabs.php?brand_username=".$username."&"); ?>
                </div>
                <!-- /.row -->
