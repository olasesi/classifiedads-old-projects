...
$page_title = 'Clothings - Myshoptwo';
$descript = 'Get the latest clothings at affordable prices. Get extra pay for buying from our e-shop.';
...
?>
  ...
  <div class="container">
        ...
        <div class="row">
		   ...
		   $statement = "goods WHERE categories = 'Clothings' AND UID = '".$user_id."' ORDER BY goods_timestamp DESC"; 
		   ...
		   <!-- /.col -->
			...
			<div class="col-xs-6 col-sm-8 col-md-9">
                 <div>
                   <h2 class="text-center text-primary">Clothings</h2>
                </div>
                <!-- /.div -->
                <div class="row">
                    <div class="btn-group alg-right-pad">
						...
						<?php 
						$total_products = mysqli_query($connect, "SELECT * FROM goods WHERE categories = 'Clothings' AND UID = '".$user_id."'") or die(db_conn_error);
                ...
                <!-- /.row -->
                <div class="row">
                      <?php echo pagination($statement,$per_page,$page,$url=MYSHOPTWO."/my-shop-clothings.php?brand_username=".$username."&"); ?>
                </div>
                <!-- /.row -->
